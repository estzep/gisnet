...
<header class="aboutUs">
    <div class="container">
        <div class="content">
            ...
            <div class="image">
                <img src="<? echo $path ?>src/assets/img/nosotros/img-1.jpg" alt="Sobre Gisnet">
            </div>
        </div>
    </div>
</header>
...
<section>
    <div class="section-container container">
        <div class="content mixed-content-1 pb-0">
            ...
            <div class="image f">
                <img src="<? echo $path ?>src/assets/img/nosotros/img-2.jpg" alt="Sobre Gisnet">
            </div>
        </div>
    </div>
</section>
<section>
    <div class="section-container container">
        <div class="content mixed-content-1 pb-0">
            <div class="image s">
                <img src="<? echo $path ?>src/assets/img/nosotros/img-3.jpg" alt="Sobre Gisnet">
            </div>
            <div class="info">
