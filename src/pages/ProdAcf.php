        ...
        <div class="content mixed-content-1">
            ...
            <div class="note">
                <p class="text-1 text-center">
                    De igual manera se cuenta con <span class="strong-black">diferentes indicadores</span> entre los cuáles destacan el  servicio al cliente, negocio, caja, ventas y back office.
                </p>
            </div>
        </div>
    </div>
