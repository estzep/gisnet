                ...
                <div class="tabs-container">
                    <div id="tab-registral" class="tab active">
                        <div class="tab-content">
                            ...
                            <div class="image">
                                <img src="<? echo($path) ?>src/assets/img/services/implementacion-de-sistemas/img-2-gisreg.jpg" alt="Image">
                            </div>
                        </div>
                    </div>
                    <div id="tab-catastral" class="tab">
                        <div class="tab-content">
                            ...
                            <div class="image">
                                <img src="<? echo($path) ?>src/assets/img/services/implementacion-de-sistemas/img-2-giscat.jpg" alt="Image">
                            </div>
                        </div>
                    </div>
