            ...
            <div class="links">
                <div class="links-container container">
                    <ul id="accordionLinks" class="links-content accordion">
                        ...
                        <div id="collapseNavbarServicios" class="accordion-collapse servicios collapse" data-bs-parent="#accordionLinks" data-bs-toggle="collapse">
                            <ul class="dropdown">
                        ...
                        <div id="collapseNavbarProductos" class="accordion-collapse productos collapse" data-bs-parent="#accordionLinks" data-bs-toggle="collapse">
                            <ul class="dropdown">
                                <li class="dropdown-item">
